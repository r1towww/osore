...
CObjPoison::CObjPoison(float x, float y, float r, float speed)
{
	m_x = x;
	m_y = y;
	m_r = r;
...
void CObjPoison::Init()
{
	...
	//当たり判定用HitBoxを作成
	Hits::SetHitBox(this, m_x, m_y, 25, 25, ELEMENT_ENEMY, OBJ_POISON, 1);
}

//アクション
void CObjPoison::Action()
{
	//行動が制御されている場合（メニュー画面）
